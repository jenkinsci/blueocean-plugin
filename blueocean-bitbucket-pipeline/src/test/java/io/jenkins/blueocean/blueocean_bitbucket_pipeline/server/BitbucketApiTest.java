...
public class BitbucketApiTest extends BitbucketWireMockBase{
    ...
    public void setup() throws Exception {
        ...
        StandardUsernamePasswordCredentials credentials = new StandardUsernamePasswordCredentials(){
            @Override
        ...
        this.api = new BitbucketServerApi(apiUrl, credentials);
    }
    ...
    public void getUser(){
        ...
        assertNotNull(user);
        assertEquals(this.user, user.getSlug());
    }
