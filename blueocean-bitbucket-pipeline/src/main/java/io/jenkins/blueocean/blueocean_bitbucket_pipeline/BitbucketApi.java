...
public abstract class BitbucketApi {
    ...
    public @Nonnull abstract BbPage<BbProject> getProjects(int start, int limit);

    public @Nonnull abstract BbProject getProject(@Nonnull String projectName);

    public @Nonnull abstract BbRepo getRepo(@Nonnull String projectKey, String repoSlug);

    public @Nonnull abstract BbPage<BbRepo> getRepos(@Nonnull String projectKey, int pageNumber, int pageSize);

    public @Nonnull abstract String getContent(@Nonnull String projectKey, @Nonnull String repoSlug, @Nonnull String path, @Nonnull String commitId);
    ...
    public @CheckForNull abstract BbBranch getBranch(@Nonnull String projectKey, @Nonnull String repoSlug, @Nonnull String branch);

    public @Nonnull abstract BbBranch createBranch(@Nonnull String projectKey, @Nonnull String repoSlug, Map<String, String> payload);

    public @CheckForNull abstract BbBranch getDefaultBranch(@Nonnull String projectKey, @Nonnull String repoSlug);

    public abstract boolean isEmptyRepo(@NotNull String projectKey, @Nonnull String repoSlug);
}
