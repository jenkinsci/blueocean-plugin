...
public class GitContent extends ScmContent {
    ...
    public GitContent(String owner, String repo, String path, String message, String base64Data, String sha, String branch, String sourceBranch, Boolean autoCreateBranch) {
        this(null, owner, repo, path, 0, message, base64Data, sha, branch, sourceBranch, autoCreateBranch);
    }

    public GitContent(String name, String owner, String repo, String path, Number size, String message, String base64Data, String sha, String branch, String sourceBranch, Boolean autoCreateBranch) {
        this.name = name;
        this.owner = owner;
        this.repo = repo;
        this.path = path;
    ...
    public static class Builder {
        ...
        public GitContent build() {
            return new GitContent(name, owner, repo, path, size, message, base64Data, sha, branch, sourceBranch, autoCreateBranch);
        }
    }
}
