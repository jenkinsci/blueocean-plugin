...
export const actions = {
    ...
    fetchPipelines(config, organizationName) {
        return (dispatch) => {
            ...
            const url = `${baseUrl}/rest/search/?q=type:pipeline;excludedFromFlattening=jenkins.branch.MultiBranchProject;excludedFromFlattening:jenkins.branch.MultiBranchProject`;
