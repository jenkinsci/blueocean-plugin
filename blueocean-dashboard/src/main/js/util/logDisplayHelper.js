...
export function getNodesInformation(ignored) {
    // TODO: remove this once we're sure it's never getting called
    console.error('called old getNodesInformation!');
    throw new Error('called old getNodesInformation');
}

export function getNodesInformationForSteps(nodes) {
    // TODO: make this only do what we actually need for steps
