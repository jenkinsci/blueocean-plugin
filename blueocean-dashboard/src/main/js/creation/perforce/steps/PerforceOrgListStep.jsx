...
@observer
export default class PerforceOrgListStep extends React.Component {
    ...
    render() {
        ...
        const title = 'Which project does the repository belong to?';
        const disabled = flowManager.stepsDisabled;

        return (
            <FlowStep {...this.props} className="perforce-org-list-step layout-large" title={title} disabled={disabled}>
                <List
                    className="org-list"
