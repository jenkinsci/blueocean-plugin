...
module.exports = {
    ...
    elements: {
        ...
        highlightedGraph: 'g.PWGx-pipeline-selection-highlight',
...
module.exports.commands = [
     ...
     */
        ...
        pageUrl: function(relative) {
            ...
            return !relative ? this.api.launchUrl + runUrl : runUrl;
        },
        /**
        ...
        clickFirstResultItem: function(expand) {
            const self = this;
            self.waitForElementVisible('@firstResult').click('@firstResult', isCodeBlockVisibleCallback(self, expand));
        ...
        clickFirstResultItemFailure: function(expand) {
            const self = this;
            self.waitForElementVisible('@firstErrorResult').click('@firstErrorResult', isCodeBlockVisibleCallback(self, expand));
        ...
        validateScrollToBottom: function() {
            ...
            browser.execute(
                function(selector) {
                    const cmElem = document.evaluate(selector, document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
                    // return the scrollHeight to determine whether we moved to the bottom on karaoke
                    return cmElem.scrollHeight;
                },
                ['//div[@class="FullScreen-contents"]'],
                function(result) {
                    // sanity checks
        ...
        validateLogConsole: function(position) {
            ...
            browser
                ...
                .getAttribute(aXpath, 'href', function(result) {
                    ...
                    browser.click(aXpath).url(function(response) {
