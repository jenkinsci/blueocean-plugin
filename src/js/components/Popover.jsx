...
export class Popover extends Component {
    ...
    measureDOMNodes() {
        ...
        // Measure self
        const selfNode = this.refs.popover;
        if (selfNode) {
    ...
    render() {
        ...
        const position = sanitizePosition(this.props.position || positionAbove);
        const pointClassName = 'Popover-point Popover-point--' + position;

        return (
            <div className="Popover">
                <div ref="screen" className="Popover-modalScreen" onClick={this.modalScreenClicked}/>
                <div ref="popover" className="Popover-wrapper" style={popoverStyle}>
