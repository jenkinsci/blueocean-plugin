...
import io.jenkins.blueocean.rest.BlueOceanRestApi;
 ...
 */
public abstract class OrganizationContainer extends Container<Organization> implements BlueOceanRestApi, ExtensionPoint {
    @WebMethod(name="") @POST
