...
describe("ExtensionStore.js", function () {
    ...
    it("- test ", function (done) {
        jsTest.onPage(function() {
            ...
            var ExtensionStore = require('../src/ExtensionStore');
            ...
            jsModules.import = function(bundleId) {
                ...
                for(var i1 = 0; i1 < javaScriptExtensionInfo.length; i1++) {
                    ...
                    for(var i2 = 0; i2 < extensions.length; i2++) {
                        ExtensionStore.register(extensions[i2].component, extensions[i2].extensionPoint);
                    }
                }
            ...
            ExtensionStore.setExtensionPointMetadata(javaScriptExtensionInfo);
            ...
            ExtensionStore.load('ep-1', function() {
                if (loaded === 2) {
                    ...
                    ExtensionStore.load('ep-1', function() {
                        ...
                        ExtensionStore.load('ep-2', function() {
                            expect(loaded, 2);
                            done();
                        });
                    });
