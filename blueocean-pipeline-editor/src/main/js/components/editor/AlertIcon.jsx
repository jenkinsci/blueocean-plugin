...
export default () => (
    <svg className="alerticon" width="20px" height="20px" viewBox="13 9 20 20">
        ...
        <g id="Group-10" stroke="none" strokeWidth="1" fill="none" fill-rule="evenodd" transform="translate(15, 9)">
            ...
            <use id="Rectangle-17-Copy" stroke="#FFFFFF" mask="url(#mask-6)" strokeWidth="2" fill="#D8D8D8" xlinkHref="#path-5" />
        </g>
    </svg>
);
