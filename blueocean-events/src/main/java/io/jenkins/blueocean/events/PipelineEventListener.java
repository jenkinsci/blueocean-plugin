    ...
    private class StageEventPublisher implements GraphListener {
        ...
        public void onNewHead(FlowNode flowNode) {
            if (flowNode instanceof StepStartNode) {
                ...
                LOGGER.log(Level.INFO, "Flow node Displayname: " + flowNode.getDisplayName() +
                		" DisplayFnname "+flowNode.getDisplayFunctionName()+
                		"Node Label: "+flowNode.getNodeLabel());
        ...
        private Message newMessage(PipelineEventChannel.Event event, FlowNode flowNode, List<String> branch) {
            ...
            if (flowNode instanceof StepNode) {
                ...
                message.set(PipelineEventChannel.EventProps.pipeline_step_label, 
                		flowNode.getNodeLabel()!=null?flowNode.getNodeLabel():stepNode.getDescriptor().getDisplayName());
            }
