...
public class GithubPipelineCreatorImpl extends BluePipelineCreator {
    ...
    public static class RequestImpl extends AbstractPipelineCreateRequestImpl{
        ...
        private BlueScmConfig scmConfig = new BlueScmConfig();
        ...
        public BluePipeline create(Reachable parent) throws IOException {
            ...
            TopLevelItem item = create(Jenkins.getInstance(),name, DESCRIPTOR, CustomOrganizationFolderDescriptor.class);
